...
export class NetworkRegistry {
  private giwa: GiwaInfrastructure;
  ...
  public async getLatestFinalizedBlock(): Promise<number> {
  ...
  public async getNodeHealth(): Promise<string> {
    try {
      const status = await this.giwa.getNetworkStatus();
  ...
  public async getGasOracle(): Promise<number> {
    try {
  ...
  public async getBridgeHealth(): Promise<string> {
    try {
